...
public class AlloyObjectExprImpl extends AlloyExprImpl implements AlloyObjectExpr {
  ...
  @Override
  @NotNull
  public AlloyFieldList getFieldList() {
    return findNotNullChildByClass(AlloyFieldList.class);
  }
